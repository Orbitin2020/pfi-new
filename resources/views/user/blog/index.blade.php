            ...
            <div class="row">
                <div class="col-xl-8 col-lg-8 m-b40">
                    ...
                    <div class="dz-card style-1 shadow m-b30">
                        <div class="dz-media">
                            <a href="{{route('user.blog.detail',$d->slug)}}"><img
                        ...
                        <div class="dz-info">
                            ...
                            <h3 class="dz-title"><a href="{{route('user.blog.detail', $d->slug)}}">{{($d->judul)}}</a>
                            </h3>
                    ...
                    <nav aria-label="Blog Pagination">
                        ...
                        <ul class="pagination text-center m-b30 m-t50 m-lg-t10">
                            ...
                            @else
                            <li class="page-item"><a class="page-link prev" href="{{ $blog->previousPageUrl() }}"><i
                                        class="fas fa-chevron-left"></i></a></li>
                            @endif --}}
                            {{ $blog->links() }}
                            {{-- @if ($blog->hasMorePages())
                            <li class="page-item"><a class="page-link next" href="{{ $blog->nextPageUrl() }}"><i
