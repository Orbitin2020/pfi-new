            ...
            <div class="dz-bnr-inr-entry">
                ...
                <nav aria-label="breadcrumb" class="breadcrumb-row">
                    <ul class="breadcrumb">
                        ...
                        <li class="breadcrumb-item active" aria-current="page">Management Control System Development
                        </li>
                    </ul>
                </nav>
                <!-- Breadcrumb Row End -->
                    ...
                    <div class="about-content">
                        <div class="section-head style-1">
                            ...
                            <p align="justify">
                                ...
                                integrated management control system to facilitate the documentation of related job
                                components and responsibilities of work areas within the organization. Their
                                relationship to the operation as a whole will also be examined and evaluated. All of
                                these will then be used for the provision of work assignments, operations control,
