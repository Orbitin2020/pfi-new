...
<div class="page-content bg-white">
    ...
    <div class="main-slider2">
        <div class="swiper-container main-slider-2 banner-inner">
            <div class="swiper-wrapper">
                <div class="swiper-slide" style="background-image: url(assets_user/images/main-slider/slider2.jpg); background-size: cover;">
                ...
                <div class="swiper-slide" style="background-image: url(assets_user/images/main-slider/slider3.jpg); background-size: cover;">
                    <div class="banner-content container">
                        <div class="row">
                            <div class="col-lg-9">
                                <h1 class="title" data-swiper-parallax="-500">Consulting Services</h1>
                                <p data-swiper-parallax="-1000">
                                    Transformation of total management culture and operation system, which will produce measurable result in productivity improvement by enchancing the managerial ability of corporations, management, replace entrenched and counterproductive methods with productive and profitable techniques and install a system that gives front line supervisors control at the point of execution 
                                    <ul data-swiper-parallax="-1000">
                                        ...
                                        <li data-swiper-parallax="-1000" style="color: white">Return of investment (ROI) between 100% - 250% annually</li>
                                        <li data-swiper-parallax="-1000" style="color: white">Guarantee and expected improvement to the project</li>
                ...
                <div class="swiper-slide" style="background-image: url(assets_user/images/main-slider/slider4.jpg); background-size: cover;">
                    <div class="banner-content container">
                        <div class="row">
                            <div class="col-lg-9">
    ...
    <section class="content-inner bg-white">
        <div class="container">
            <div class="row about-style2 align-items-center">
                ...
                <div class="col-lg-6 m-b30">
                    <div class="row align-items-end aos-item" data-aos="fade-up" data-aos-duration="800" data-aos-delay="200">
                        <div class="col-sm-8 m-b30">	
                            <div class="about-thumb">
                                <div class="split-box">
                                    <div>
                                        <img class="w-100" src="{{asset('assets_user/images/about/about1.jpg')}}" alt="">
                                    </div>
                                </div>
                                <a href="https://www.youtube.com/watch?v=_FRZVScwggM" class="popup-youtube play-btn3">Play Video</a>
                            </div>
                        </div>
                        <div class="col-sm-4">
                            <div class="counter-style-1 m-b30 aos-item" data-aos="fade-up" data-aos-duration="800" data-aos-delay="400">
                            ...
                            <div class="counter-style-1 m-b30 aos-item" data-aos="fade-up" data-aos-duration="800" data-aos-delay="600">
                                <div class="counter-num text-primary">
                            ...
                            {{-- <div class="counter-style-1 m-b30 aos-item" data-aos="fade-up" data-aos-duration="800" data-aos-delay="800">
                                <div class="counter-num text-primary">
    ...
    <section class="content-inner-2 service-wrapper-2 overlay-black-dark" style="background-image:url('assets_user/images/background/bg7.jpg');background-size: cover;">
        <div class="container">
                ...
                <div class="swiper-container service-slider">
                    <div class="swiper-wrapper">
                        <div class="swiper-slide">
                            <div class="content-box overlay-shine aos-item" data-aos="fade-up" data-aos-duration="800" data-aos-delay="400">
                                <div class="dz-media">
                        ...
                        <div class="swiper-slide">
                            <div class="content-box overlay-shine aos-item" data-aos="fade-up" data-aos-duration="800" data-aos-delay="600">
                                <div class="dz-media">
    ...
    <section class="content-inner-1">
        <div class="container">
            <div class="swiper-container testimonial-swiper2">
                <div class="swiper-wrapper">
                    <div class="swiper-slide">
                        <div class="testimonial-2 aos-item" data-aos="fade-up" data-aos-duration="800" data-aos-delay="200">
                    ...
                    <div class="swiper-slide">
                        <div class="testimonial-2 aos-item" data-aos="fade-up" data-aos-duration="800" data-aos-delay="400">
                            <div class="testimonial-pic">
                    ...
                    <div class="swiper-slide">
                        <div class="testimonial-2 aos-item" data-aos="fade-up" data-aos-duration="800" data-aos-delay="600">
                            <div class="testimonial-pic">
            ...
            <div class="row sp15 aos-item" data-aos="fade-in" data-aos-duration="800" data-aos-delay="400">
                <div class="col-xl-3 col-md-6 m-b15">
                    <div class="image-tooltip-effect dz-box style-2">
                        <a href="portfolio-details.html" class="dz-media height-md" style="background-image:url('assets_user/images/work/work-2/pic1.jpg');"></a>
                        <div class="dz-info">
                ...
                <div class="col-xl-3 col-md-6 m-b15">
                    <div class="image-tooltip-effect dz-box style-2">
                        <a href="portfolio-details.html" class="dz-media height-md" style="background-image:url('assets_user/images/work/work-2/pic2.jpg');"></a>
                        <div class="dz-info">
                ...
                <div class="col-xl-6 col-md-6 m-b15">
                    <div class="image-tooltip-effect dz-box style-2">
                        <a href="portfolio-details.html" class="dz-media height-md" style="background-image:url('assets_user/images/work/work-2/pic3.jpg');"></a>
                        <div class="dz-info">
                ...
                <div class="col-xl-6 col-md-6 m-b15">
                    <div class="image-tooltip-effect dz-box style-2">
                        <a href="portfolio-details.html" class="dz-media height-md" style="background-image:url('assets_user/images/work/work-2/pic4.jpg');"></a>
                        <div class="dz-info">
                ...
                <div class="col-xl-3 col-md-6 m-b15">
                    <div class="image-tooltip-effect dz-box style-2">
                        <a href="portfolio-details.html" class="dz-media height-md" style="background-image:url('assets_user/images/work/work-2/pic5.jpg');"></a>
                        <div class="dz-info">
                ...
                <div class="col-xl-3 col-md-6 m-b15">
                    <div class="image-tooltip-effect dz-box style-2">
                        <a href="portfolio-details.html" class="dz-media height-md" style="background-image:url('assets_user/images/work/work-2/pic6.jpg');"></a>
                        <div class="dz-info">
                            <h4 class="title m-b10">Flexible Manufacturing</h4>
                ...
                <div class="col-xl-3 col-md-6 m-b15">
                    <div class="image-tooltip-effect dz-box style-2">
                        <a href="portfolio-details.html" class="dz-media height-md" style="background-image:url('assets_user/images/work/work-2/pic7.jpg');"></a>
                        <div class="dz-info">
                            <h4 class="title m-b10">Best Engineering</h4>
                ...
                <div class="col-xl-3 col-md-6 m-b15">
                    <div class="image-tooltip-effect dz-box style-2">
                        <a href="portfolio-details.html" class="dz-media height-md" style="background-image:url('assets_user/images/work/work-2/pic8.jpg');"></a>
                        <div class="dz-info">
                            <h4 class="title m-b10">Flexible Manufacturing</h4>
                ...
                <div class="col-xl-6 col-md-6 m-b10">
                    <div class="image-tooltip-effect dz-box style-2">
                        <a href="portfolio-details.html" class="dz-media height-md" style="background-image:url('assets_user/images/work/work-2/pic9.jpg');"></a>
                        <div class="dz-info">
                            <h4 class="title m-b10">Best Engineering</h4>
    ...
    <section class="content-inner" style="background-image:url('assets_user/images/background/bg7.png');">
        <div class="container">
            <div class="row">
                <div class="col-lg-6 m-b30">
                    <div class="contact-area1 m-r20 m-md-r0 aos-item" data-aos="fade-up" data-aos-duration="800" data-aos-delay="200">
                        <div class="section-head style-1">
                ...
                <div class="col-lg-6 m-b30 align-self-center">
                    <div class="section-head style-1 aos-item" data-aos="fade-up" data-aos-duration="800" data-aos-delay="400">
                        <h3 class="title m-b20">We Are Always Best For Industrial Solution</h3>
                    </div>
                    <ul class="list-check primary m-b40 aos-item" data-aos="fade-up" data-aos-duration="800" data-aos-delay="600">
                    ...
                    <div class="split-box">
                        <img src="{{asset('assets_user/images/about/about28.jpg')}}" alt="" class="aos-item" data-aos="fade-up" data-aos-duration="800" data-aos-delay="800">
                    </div>
                </div>
            </div>
        </div>
    ...
    {{-- <section class="section-full dz-subscribe style-1">
        <div class="container">
            <div class="subscribe-inner row align-items-center aos-item" data-aos="flip-up" data-aos-duration="800" data-aos-delay="200">
