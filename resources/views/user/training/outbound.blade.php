    ...
    <div class="dz-bnr-inr dz-bnr-inr-sm overlay-black-middle text-center"
        ...
        <div class="container">
            <div class="dz-bnr-inr-entry">
                <h1>Outbound Training </h1>
                <!-- Breadcrumb Row -->
                <nav aria-label="breadcrumb" class="breadcrumb-row">
                    <ul class="breadcrumb">
                        <li class="breadcrumb-item"><a href="index.html">Services</a></li>
                        <li class="breadcrumb-item">Training & Development</li>
                        <li class="breadcrumb-item active" aria-current="page">Outbound Training</li>
                    </ul>
                </nav>
                <!-- Breadcrumb Row End -->
            </div>
                ...
                <div class="col-lg-6 m-b30 align-self-center">
                    <div class="about-content">
                        <div class="section-head style-1">
                            <h5 class="sub-title text-primary">Outbound Training</h5>
                            <h3 class="title m-b20">We Are Here to Increase Your Knowledge With Experience</h3>
                            <p align="justify">
                                Outbound Training is a training activity that is held not only indoors but also
                                outdoors. The purpose of this activity is to build a sense of togetherness,
                                cohesiveness, sportsmanship, team work, communication, and problem solving. This
                                activity provides various examples and analogies that resemble the workplace so that
                                after this activity is carried out it can provide direct benefits for employees and the
                                company.
                            </p>
                        </div>
                        {{-- <div class="row m-b30">
