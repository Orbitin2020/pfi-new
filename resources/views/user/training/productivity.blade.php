    ...
    <div class="dz-bnr-inr dz-bnr-inr-sm overlay-black-middle text-center" style="background-image: url(/assets_user/images/bnr/bnr1.jpg);">
        <div class="container">
            <div class="dz-bnr-inr-entry">
                <h1>Productivity Talent Management </h1>
                <!-- Breadcrumb Row -->
                <nav aria-label="breadcrumb" class="breadcrumb-row">
                    <ul class="breadcrumb">
                        <li class="breadcrumb-item"><a href="index.html">Services</a></li>
                        <li class="breadcrumb-item">Training & Development</li>
                        <li class="breadcrumb-item active" aria-current="page">Productivity Talent Management</li>
                    </ul>
                </nav>
                <!-- Breadcrumb Row End -->
            </div>
                ...
                <div class="col-lg-6 m-b30 align-self-center">
                    <div class="about-content">
                        <div class="section-head style-1">
                            <h5 class="sub-title text-primary">Productivity Talent Management</h5>
                            <h3 class="title m-b20">We Are Here to Increase Your Knowledge With Experience</h3>
                            <p align="justify">
                                It is a comprehensive human resource development program consisting of several training materials that are delivered together. This program not only aims to improve existing competencies but also makes various improvements to increase company productivity indirectly.
                            </p>
                        </div>
                        <div class="row m-b30">
